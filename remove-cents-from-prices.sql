-- ==========================================
-- REMOVE CENTS FROM PRODUCT PRICES
-- ==========================================
-- Execute this SQL in your Supabase SQL Editor
-- This script removes cents from all product prices, keeping only whole hryvnias
...
-- Update all prices to remove cents (round down to whole hryvnias)
UPDATE products 
