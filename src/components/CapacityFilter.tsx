  ...
  return (
    <div className={`space-y-4 ${className}`}>
      <div className="space-y-3">
        <h4 className="font-medium text-sm">Ємність (мАг)</h4>
        ...
        <div className="flex justify-between text-xs text-muted-foreground px-2">
          <span>{localSliderValue[0].toLocaleString()} мАг</span>
          <span>{localSliderValue[1].toLocaleString()} мАг</span>
        </div>
      </div>
      ...
      <div className="space-y-2">
        ...
        <div className="text-xs text-muted-foreground text-center">
          Діапазон: {min.toLocaleString()} - {max.toLocaleString()} мАг
        </div>
      </div>
    </div>
  );
