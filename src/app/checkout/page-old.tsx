...
export default function CheckoutPage() {
  ...
  const validateForm = (): boolean => {
    ...
    if (!email) {
      newErrors.email = "Електронна пошта є обов'язковим полем";
    } else if (email.length > 100) {
      newErrors.email = "Електронна пошта не повинна перевищувати 100 символів";
    } else if (!emailRegex.test(email)) {
      newErrors.email =
        "Неправильний формат електронної пошти. Приклад: user@example.com";
    }
  ...
  const validateField = (
    ...
    if (field === "email") {
      ...
      if (!trimmedValue) {
        ...
        newErrors.email =
          "Електронна пошта не повинна перевищувати 100 символів";
                ...
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      {!errors.email && (
                        <p className="text-xs text-muted-foreground">
                          Введіть вашу електронну пошту для підтвердження
                          замовлення
                        </p>
                      )}
                    </div>
