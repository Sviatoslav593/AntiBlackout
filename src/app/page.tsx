          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              ...
              return (
                <div
                        key={category}
                        className="group relative bg-white border-2 border-gray-100 rounded-2xl p-6 hover:border-blue-200 hover:shadow-lg transition-all duration-300 cursor-pointer h-32 flex items-center justify-center"
                      ...
                      >
                        <div className="flex flex-col items-center text-center space-y-3">
                          ...
                          <div className="flex-1 flex items-center">
                            <h3 className="font-semibold text-gray-900 group-hover:text-blue-600 transition-colors duration-300 text-sm lg:text-base leading-tight">
                              {category}
                    </h3>
                          </div>
                  </div>
