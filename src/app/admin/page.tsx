...
import { Package, BarChart3, Settings, Users, ShoppingCart, Mail } from 'lucide-react';
        ...
        {adminCards.map((card) => {
          ...
          return (
            <Link key={card.href} href={card.href}>
              <Card className={`hover:shadow-lg transition-all duration-200 cursor-pointer border-2 ${card.borderColor} hover:scale-105`}>
